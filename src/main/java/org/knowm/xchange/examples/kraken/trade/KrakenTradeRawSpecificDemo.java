...
public class KrakenTradeRawSpecificDemo {
  ...
  public static void main(String[] args) throws IOException {
    ...
    KrakenStandardOrder order = // stop at -5% loss, take profit at +$10 price increase.
        KrakenStandardOrder.getLimitOrderBuilder(CurrencyPair.BTC_USD, KrakenType.BUY, "10", new BigDecimal("1"))
            .withCloseOrder(KrakenOrderType.STOP_LOSS_PROFIT, "#5%", "#10").withValidateOnly(false) // validate only for demo purposes
            .buildOrder();
